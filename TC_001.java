...
public void beforemethod() {
	//application title is given
//String ExpectedTitle ="Amazon.in : -amazon";
...
//String ActualTitle= driver.getTitle();
	//System.out.println("The title of the app is : "+ActualTitle);
	//Assert.assertEquals(ActualTitle,ExpectedTitle);//Assertion is used confirm the title of the page
driver.manage().window().maximize(); 
}

// test 
   @Test(dataProvider = "TC_001",dataProviderClass = Dataprovider.class)
   public static void TestCase1(String email, String id , String product , String name,  String phone, String postalcode, String houseno, String localad) throws Exception {
	   ExtentReports extent=new ExtentReports();
	  ExtentSparkReporter spark=new ExtentSparkReporter("C:\\Users\\anandhakrishnan.b\\OneDrive - HCL Technologies Ltd\\Documents\\reportAnandhu.html");
	  extent.attachReporter(spark);
	  ExtentTest test=extent.createTest("Verify the Daily Deals functionality");
	   
// creating actions method 
driver.manage().timeouts().implicitlyWait(25, TimeUnit.SECONDS);
...
//calling enterfullname in order to enter full name
Thread.sleep(2000);
PageObj.enterfullname(name);

//calling enterphonemunber in order to enter phone number
PageObj.enterphonemunber(phone);

//calling enterphonemunber in order to enter postal code
PageObj.enterpostalcode(postalcode);


//calling Enterhousenumber in order to enter postal code
PageObj.Enterhousenumber(houseno);

Thread.sleep(2000);
//calling enterlocaladress in order to enter postal code
PageObj.enterlocaladress(localad);

Thread.sleep(2000);
//calling Clickuseaddress in order to enter postal code
...
Thread.sleep(2000);
act.moveToElement(Youraccount).build().perform();//mouseover is used
Thread.sleep(2000);
act.moveToElement(Signout).click().build().perform();//mouseover is used to click on the sign out button
